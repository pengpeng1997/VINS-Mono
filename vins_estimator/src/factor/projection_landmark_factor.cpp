#include "projection_landmark_factor.h"

Eigen::Matrix2d ProjectionLmFactor::sqrt_info;
double ProjectionLmFactor::sum_t;

ProjectionLmFactor::ProjectionLmFactor(const Eigen::Vector3d &_pts_i, const Eigen::Vector3d &_pts_j) : pts_i(_pts_i), pts_j(_pts_j)
{
...
bool ProjectionLmFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    TicToc tic_toc;
    ...
    if (jacobians)
    {
        ...
        if (jacobians[0])//Find somewhere build your map and landmarks
        {
...
void ProjectionLmFactor::check(double **parameters)
{
